...
## [1.6.1](https://github.com/tversteeg/emplace/compare/v1.6.0...v1.6.1) - 2025-02-25
...
- add zamazan4ik as a contributor for maintenance (#402)
- add chenrui333 as a contributor for maintenance (#401)
- bump time crate to build with rust 1.80+ (#400)
